    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#saveCreateActivityRemarkBtn").click(function () {
                ...
                var activityId = '${activity.id}';//不加引号浏览器会误以为这个是变量
            ...
            $("#remarkDivList").on("click","a[name='editA']",function () {
                //获取备注的id和noteContent
                var id = $(this).attr("remarkId");
                var noteContent = $("#div_" + id + " h5").text();//父子选择器"#div_" + id + " h5"
                //把内容写到修改的模态窗口中
                $("#edit-id").val(id);
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if (data.code == "1") {
                            ...
                            //获取备注的id和noteContent
                            $("#div_" + data.retData.id + " h5").text(data.retData.noteContent);//父子选择器"#div_" + id + " h5"
