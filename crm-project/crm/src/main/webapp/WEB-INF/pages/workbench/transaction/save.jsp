	...
	<script type="text/javascript">
		$(function () {
			...
			$("#create-stage").change(function () {
				//收集参数
				//this.value;获取到的是阶段的id
				//var stageValue = $(this).find("option:selected").text();//常用
...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="15671d978f9d433dabbefcd54d0f8f19">
				<input type="text" class="form-control" id="create-activityName" value="聚餐消费">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="23b0035c0a91447690354452fcd1cdaa">
				<input type="text" class="form-control" id="create-contactsName" value="杜聚宾">
			</div>
		</div>
